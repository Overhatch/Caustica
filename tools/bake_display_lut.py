...
src/main/resources/caustica/rt/luts/; the sole LMT lives beside the default package JSON.
"""
import argparse
import hashlib
import struct
...
LOOK_PACKAGE_DIR = (
    Path(__file__).resolve().parent.parent / "src/main/resources/caustica/rt/looks/default"
)
